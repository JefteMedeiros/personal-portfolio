...
export function Bill(props: TestimonialProps) {
  return (
    <BillContainer visibility={props.visibility}>
      <UserRating>
        <Star size={32} weight="fill" />
        5.0 Star Rating
      </UserRating>
      <UserComment>
        “If you're looking for someone who will challenge your Mobile development and really cut to the core of what's important for users, then Jesse
        is your man. On top of that, he brings a level of enthusiasm to the craft that's energizing for everyone who works with him.” Bill
      </UserComment>
      <QuoteIcon>
