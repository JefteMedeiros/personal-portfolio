...
import { TimContainer } from './styles';
import { QuoteIcon, UserComment, UserRating } from '../styles';
import { TestimonialProps } from '../../../@types/testimonial';

export function Tim(props: TestimonialProps) {
  return (
    <TimContainer visibility={props.visibility}>
      <UserRating>
        <Star size={32} weight="fill" />
        5.0 Star Rating
      </UserRating>
      <UserComment>
        “If you're looking for someone who will challenge your UX/UI thinking and really cut to the core of what's important for users, then Jesse is
        your man. On top of that, he brings a level of enthusiasm to the craft that's energizing for everyone who works with him.” Tim
      </UserComment>
      <QuoteIcon>
